...
shared_ptr<PhysicsController> PhysicsFactory::CreateSpider(glm::vec3 position)
{
	...
	*/
	...
	shared_ptr<PhysicsController> upper_leg_muscle = CreateCylinder(0.5, 0.2, glm::vec3(position.x - 2, position.y -2, position.z), q);
	...
	shared_ptr<PhysicsController> mid_leg = CreateCapsule(1, 3 , glm::vec3(position.x - 13, position.y, position.z), q);
	shared_ptr<PhysicsController> mid_upper_leg_muscle = CreateCylinder(0.5, 0.2, glm::vec3(position.x - 11, position.y - 2, position.z), q);
	shared_ptr<PhysicsController> mid_lower_leg_muscle = CreateCylinder(0.5, 0.2, glm::vec3(position.x - 15, position.y - 2, position.z), q);
	...
	shared_ptr<PhysicsController> lower_leg = CreateCapsule(1, 3, glm::vec3(position.x - 26, position.y, position.z), q);
	shared_ptr<PhysicsController> lower_leg_muscle = CreateCylinder(0.5, 0.2, glm::vec3(position.x - 24, position.y - 2, position.z), q);
